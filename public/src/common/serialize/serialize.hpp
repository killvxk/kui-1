...
namespace serialize {
	...
	typedef serialize_t<
		char,
		detail::file_t<char, std::ios_base::in | std::ios_base::binary>,
		detail::empty_in_t<char, detail::file_t<char, std::ios_base::in | std::ios_base::binary>>,
		detail::binary_out_t<char, detail::file_t<char, std::ios_base::in | std::ios_base::binary>>
	> i_file_serialize;

	typedef serialize_t<
		char,
		detail::file_t<char, std::ios_base::out | std::ios_base::binary>,
		detail::binary_in_t<char, detail::file_t<char, std::ios_base::out | std::ios_base::binary>>,
		detail::empty_out_t<char, detail::file_t<char, std::ios_base::out | std::ios_base::binary>>
	> o_file_serialize;
