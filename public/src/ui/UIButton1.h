...
public:
	...
	UIButton1(AutoRef<UIView> parent, int id, int x, int y, Gdiplus::Image* image)
		:UIView(parent, id)
	{
		m_image = image;

		SetFrameRect(Gdiplus::Rect(x,y,image->GetWidth(), image->GetHeight()));
