...
public:
	...
	UIButton4(AutoRef<UIView> parent, int id, int x, int y, Gdiplus::Image* image)
		:UIView(parent, id)
	{
		m_image = image;

		SetFrameRect(Gdiplus::Rect(x,y,image->GetWidth() / 4,image->GetHeight()));
