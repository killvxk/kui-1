...
COSFDialog::COSFDialog(HWND hwnd)
{
...
BOOL COSFDialog::FileOpenDlg(PTSTR szFilter, PTSTR szDefExt,PTSTR szInitialFile, PTSTR szInitiaDir,PTSTR szDlgTitle, BOOL fMultSel)
{
	...
	if(szInitialFile != NULL)
		_tcscpy_s(m_szFileName,szInitialFile);
	m_ofn.lpstrInitialDir = szInitiaDir;
