...
{
	//src = "Ò»¶þÈýËÄÎåÁùÆß°Ë¾ÅÊ®";
	//src = "Ò¼Ê°·¡ÒÚÈþÇªËÁ°ÛÎéÊ°Â½ÍòÆâÇª°Æ°Û¾ÁÊ°";
	std::string dst;
...
std::string FindPyLetter(int nCode)
{
	...
	default:
		...
		if((nCode>=2288 && nCode<=2231) || nCode == 2294)
		{
			strValue="ER";
			break;
		}
...
std::string GetFirstLetter(LPCSTR strName)
{
	...
	int H, L, W;
	INT_PTR i, stringlen = ::strlen(strName);
	INT_PTR j;
