...
/*
	Use ENABLE_CPP0X_OPTIONS, We can enable HAVE_CPP0X_* when compiler has "-std=c++0x" flag.
*/
#ifndef ENABLE_CPP0X_OPTIONS
#define ENABLE_CPP0X_OPTIONS	0
#endif

#if (ENABLE_CPP0X_OPTIONS)
